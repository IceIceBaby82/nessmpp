...
// BindTransmitter represents an SMPP bind_transmitter PDU
...
func (bt *BindTransmitter) Marshal() ([]byte, error) {
	...
	bt.Header.CommandID = BIND_TRANSMITTER
...
func (bt *BindTransmitter) Unmarshal(data []byte) error {
	var err error
